...
function is_valid($array_item_name, $array) {
...
$query = '';
$price = '';
if (is_valid('query', $_GET)) {
  $query = "value='".$_GET['query']."'";
};
if (is_valid('price', $_GET)) {
  $price = "value='".$_GET['price']."'";
};
$lessThan = 'checked';
$equals = '';
$greaterThan = '';
if (is_valid('priceSort', $_GET)) {
   ...
   print '
    ...
    <div class="container align-items-stretch mt-3">
      ...
      if (is_valid('query', $_GET)) {
        ...
        $wq = "%".$_GET['query']."%";
        $q = $_GET['query'];
        array_push($statementPlaceholders, $wq, $wq, $q, $wq, $q, $wq, $q, $wq, $wq, $wq);
      };
